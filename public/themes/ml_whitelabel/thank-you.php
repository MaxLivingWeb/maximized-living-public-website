...
get_header(); ?>
    <div class="hero hero-thankYou wave wave-multi"
         style="padding: 12rem 0; background-image:url('<?php echo get_template_directory_uri(); ?>/images/mainHero.jpg');"
         id="content">
        <div class="heroContent centerAlign">
            <h1 class="heroHeadline">Thanks<?php if (isset($_GET['n'])) {
                    echo ', ' . $_GET['n'];
                } ?>!</h1>
            ...
            <?php if (1 === 2): ?>
                ...
                <p class="heroDescription">
                    Someone from <?php echo get_bloginfo('name'); ?> will reach out to you soon. In the meantime, learn
                    more about
                    how MaxLiving and the 5 Essentials<sup>&trade;</sup> can help you reach your health and wellness goals.
                </p>
                <a href="<?php echo get_home_url(); ?>/five-essentials">
                    <button class="button button-large" title="Discover the 5 Essentials">
