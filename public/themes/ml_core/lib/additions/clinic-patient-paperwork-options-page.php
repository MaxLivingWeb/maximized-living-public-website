...
if( function_exists('acf_add_options_page') && get_current_blog_id() != 1 ) {
    $clinic_paperwork = array(

        /* (string) The title displayed on the options page. Required. */
        'page_title' => 'Patient Paperwork',

        /* (string) The title displayed in the wp-admin sidebar. Defaults to page_title */
        'menu_title' => 'Patient Paperwork',
        ...
        'menu_slug' => 'patient-paperwork-page-options',
        ...
        'post_id' => 'clinic_patient_paperwork_options',
    ...
    acf_add_options_page($clinic_paperwork);
}
