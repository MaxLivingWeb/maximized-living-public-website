...
$my_future_thank_you = get_page_by_path("myfuture-thank-you");

get_header();
?>
    <div class="hero wave wave-multi" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/mainHero.jpg');">
    ...
    <article class="container">
        ...
        <ul>
            <?php wp_list_pages('exclude='.$sitemap_page->ID.','.$thank_you->ID.','.$my_future_thank_you->ID ); ?>
