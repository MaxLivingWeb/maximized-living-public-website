...
class NSUR {
        ...
        public  $plugin_file;
            ...
            private function __construct() {            
					...
					add_filter( 'network_site_url', array( $this, 'nsur_login_link_creation' ), 10, 3 );
											
					// on the activate account page redirect to the subsite home page
					add_filter( 'network_home_url', array( $this, 'nsur_home_link_creation' ), 10, 3 );
            ...
            */
             ...
             */
            public function nsur_login_link_creation( $url, $path, $scheme  ) {

					if ( 'login' == $scheme ) {
						
						// override the network_site_url() functionality when used to create the login link.				
						// switch to the initiating subsite
						switch_to_blog( get_current_blog_id() );				
						$url = site_url('/wp-login.php') ;						
						remove_filter( 'network_site_url', array( $this, 'nsur_login_link_creation' ), 10 );
						restore_current_blog();					
             ...
             /**
             * override the network_home_url() functionality when used to create the home link.
			 * we redirect to the originating sub-site for creation the home link.
             *
             * @access public	 
             * @return $url for the subsite login link.
             */
            public function nsur_home_link_creation( $url, $path, $scheme ) {

					$url = site_url('/wp-login.php') ;
					remove_filter( 'network_home_url', array( $this, 'nsur_home_link_creation' ), 10 );
