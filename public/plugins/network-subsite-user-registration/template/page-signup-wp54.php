...
/**
 * This is a modified version of the WordPress 5.4 wp-signup.php template
 */
...
// nsur commented out we know we are on a Network already
// and NSRU has replaced the standard WP wp-signup.php template
// with its own (e.g. this file) with minor alterations.
//if ( ! is_main_site() ) {
