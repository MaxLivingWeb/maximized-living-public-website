...
Tags: smtp setting, mail, data, smtp simple, smtp config, sendmail, send mail, send test, mailer, mail function, php mailer 
Requires at least: 3.5
Tested up to: 5.2.2
Stable tag: 1.1.9

SMTP settings, mail function to send mail, save data in WP Mail ( php mailer ).

It is extremely easy to configure and very fast.  

== Description == 

SMTP Mail is a plugin config SMTP, mail function to send mail, save data in WP Mail ( php mailer ).
