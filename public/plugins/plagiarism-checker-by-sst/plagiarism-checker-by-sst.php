...
/*
  ...
  Description: Our Wordpress plugin checks your post before it is published. It checks each and every sentence against billions of sentences already indexed on various search engines
  Version: 2.1.1
...
class SST_WP_seo{
	...
	{
		 add_menu_page( 'SST Setting Page', 'SST Setting Page', 'manage_options', 'sst-settings', array(
                          __CLASS__,
                         'sst_files_path'
                        ), plugins_url('imgs/fav.png', __FILE__),'14.6');
	}
	function sst_files_path()
	{
    ...
    function sst_wpa_deactivate(){
        @update_option('smallseotools_acckey', "");
    }
    function sst_wpa_uninstall(){
