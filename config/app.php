...
define('WP_SITEURL', hostURL() . WP_CORE_DIRECTORY);
 ...
 */
define('DB_NAME', 'arcane');
define('DB_USER', 'arcane');
define('DB_PASSWORD', 'peunei2Aer');
define('DB_HOST', 'mysql.production');
...
/**
 * MaxLiving Multisite Setup
 */
if(env('MULTISITE') == true && env('MULTISITE_ENABLED') == true) {
    define('MULTISITE', true);
    define('SUBDOMAIN_INSTALL', env('SUBDOMAIN_INSTALL', false));
    define('DOMAIN_CURRENT_SITE', env('DOMAIN_CURRENT_SITE', 'maxliving.com'));
